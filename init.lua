    ...
    config = function()
      ...
      cmp.setup {
        ...
        sources = cmp.config.sources({
          { name = 'nvim_lsp', priority = 1000 }, -- LSP suggestions (highest priority)
        ...
        formatting = {
          fields = { 'kind', 'abbr', 'menu' }, -- Order of fields in the completion menu
        ...
        completion = {
          ...
          max_items = 10, -- Limit the number of items displayed
        },
        experimental = {
          ghost_text = false,
        },
